...
public class CarService {
    ...
    public Car findById(Long id) {
        ...
        Location location = this.mapsClient.getAddress(car.get().getLocation());
    ...
    public Car save(Car car) {
        System.out.println("car to be saved: " + car);
        if (car.getId() != null) {
...
//        car.setLocation(car.getLocation());
        ...
        System.out.println("car to be saved after setting condition: " + car);
